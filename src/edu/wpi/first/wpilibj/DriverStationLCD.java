...
public class DriverStationLCD extends SensorBase implements IInputOutput{
    ...
    public static class Line {
         ...
         */
        public static final DriverStationLCD.Line kMain6 = new DriverStationLCD.Line(kMain6_val);
        /**
         * Line on the user screen
         */
        public static final DriverStationLCD.Line kUser2 = new DriverStationLCD.Line(kUser2_val);
        /**
         * Line on the user screen
         */
        public static final DriverStationLCD.Line kUser3 = new DriverStationLCD.Line(kUser3_val);
        /**
         * Line on the user screen
         */
        public static final DriverStationLCD.Line kUser4 = new DriverStationLCD.Line(kUser4_val);
        /**
         * Line on the user screen
         */
        public static final DriverStationLCD.Line kUser5 = new DriverStationLCD.Line(kUser5_val);
        /**
         * Line on the user screen
         */
        public static final DriverStationLCD.Line kUser6 = new DriverStationLCD.Line(kUser6_val);
     ...
     */
    public void println(DriverStationLCD.Line line, int startingColumn, String text) {
     ...
     * @param text the text to print
     */
    public void println(DriverStationLCD.Line line, int startingColumn, StringBuffer text) {
        int start = startingColumn - 1;
        int maxLength = kLineLength - start;
